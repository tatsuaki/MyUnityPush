...
- (void)videoDidStart:(TJPlacement*)placement {
	[[TapjoyConnectPlugin sharedTapjoyConnectPlugin] placementVideoDidStart:myGuid_];
}

- (void)videoDidComplete:(TJPlacement*)placement {
    [[TapjoyConnectPlugin sharedTapjoyConnectPlugin] placementVideoDidComplete:myGuid_];
}

- (void)videoDidFail:(TJPlacement*)placement error:(NSString*)errorMsg {
	[[TapjoyConnectPlugin sharedTapjoyConnectPlugin] placementVideoDidFail:myGuid_ error:errorMsg];
}
@end
